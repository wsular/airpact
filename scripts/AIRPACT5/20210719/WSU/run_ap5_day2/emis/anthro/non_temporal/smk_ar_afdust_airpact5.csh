...
#
   setenv SECTOR               nonpoint_nonroad-other
   setenv SUBSECT              all_afdust

# set Assigns file name
  setenv ASSIGNS_FILE ${PBS_O_WORKDIR}/emis/anthro/assigns/ASSIGNS.AIRPACT5_2014nw.csh
  source $ASSIGNS_FILE
...
#   setenv SMK_PROCESS_HAPS    NONE # This is for SMOKE 2.7 ALL|NONE|PARTIAL
...
## Multiple-program controls
   ...
   setenv REPORT_DEFAULTS      Y   # Y reports sources that use default cross-reference
   ...
   setenv SMK_MAXWARNING       1000 # maximum number of warning messages in log file
   setenv FULLSCC_ONLY         N

## Script settings
   setenv SRCABBR              ar_{$SUBSECT}  # abbreviation for naming log files
