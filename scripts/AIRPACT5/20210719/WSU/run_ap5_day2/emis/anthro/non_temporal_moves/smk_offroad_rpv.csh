#!/bin/csh -f
#
# Version @(#)$Id: smk_offroad-rpv_MOVES.csh,v 1.1 2010/09/26 20:30:33 bbaek Exp $
# Path    $Source: /afs/isis/depts/cep/emc/apps/archive/smoke/smoke/scripts/run/smk_offroad-rpv_MOVES.csh,v $
...
## Time-dependent programs
      setenv RUN_MOVESMRG  N          # run merge program
...
#
   ...
   while ( $cnt < $EPI_NDAY )
	...
	#unsetenv LOGFILE
	#$SCRIPTS/run/run.m3combo.cb05.to.saprc99.offroad-rpv.csh $mout_cb05 $mout_saprc99
