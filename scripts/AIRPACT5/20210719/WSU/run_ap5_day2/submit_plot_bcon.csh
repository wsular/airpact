...
#  usage examples:
#   
#       ./submit_plot_bcon_day2.csh 
#       ./submit_plot_bcon_day2.csh 20151123
#       ./submit_plot_bcon_day2.csh 20151123  185503
# 
...
# job submission -------------------------------------------------------
  # create qsub script
    /bin/sed -f input4sed.txt < blueprints/blueprint_qsub_plot_bcon.txt > $qsubfile
  echo `date` "submitting plot_bcon for" $firstday
