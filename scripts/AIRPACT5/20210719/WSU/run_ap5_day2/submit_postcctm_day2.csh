...
#  usage examples:
#   
#       ./submit_postcctm_day2.csh 
#       ./submit_postcctm_day2.csh <firstday in YYYYMMDD>
#       ./submit_postcctm_day2.csh <firstday in YYYYMMDD> <runid2waiton>
#       ./submit_postcctm_day2.csh <firstday in YYYYMMDD> <runid2waiton> <runid2waiton>
# 
...
#    start.
#
#    JKV 112317 Increased walltime to cover sleep added in post processing, to prevent collision w/ day1.
#    JKV 011420 Added a new jobsID to force day2 postcctm to wait on day1 postcctm job.
...
# job submission -------------------------------------------------------
  ...
  if ( $?runid0 && $?runid1 ) then # if waiting on two jobs to finish
