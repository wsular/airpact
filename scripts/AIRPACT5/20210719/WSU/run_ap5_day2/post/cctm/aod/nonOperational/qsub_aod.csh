...
#PBS -d ~airpact5/AIRHOME/run_fastscratch
#PBS -o ~airpact5/AIRHOME/run_fastscratch/post/cctm/aod
#PBS -e ~airpact5/AIRHOME/run_fastscratch/post/cctm/aod
#PBS -j oe
...
#> during testing ------------------------------------------------------
   ...
   if ( ! $?AIROUT ) then
      ...
      set AIRSAVE = /data//airpact5/saved/$YEAR
   endif
