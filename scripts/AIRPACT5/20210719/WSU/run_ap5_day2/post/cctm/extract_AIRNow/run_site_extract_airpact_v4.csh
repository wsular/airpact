...
# 
#   > ./run_site_extract_airpact_v4.csh 20160223
#
#       This scripts extract hourly O3, PM2.5, WSPMPM.25, NOx and CO tracer results 
...
#> check environment variable ------------------------------------------
   ...
   if ( ! $?mciproot )      set mciproot      = /data/lar/projects/airpact5/AIRRUNDAY2/$YEAR
...
#> run the extraction script -------------------------------------------
   ...
   cd $AIROUT/POST/CCTM
   ~airpact5/AIRHOME/build/extract_AIRNow/site_extract_v4.x   >&! $AIRLOGDIR/post/log04b_post_xtr4airnow.txt
