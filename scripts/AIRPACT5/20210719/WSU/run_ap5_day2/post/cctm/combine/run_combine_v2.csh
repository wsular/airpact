...
#> during testing 
   ...
   if ( ! $?PBS_O_WORKDIR ) then
      ...
      set AIROUT = /data/lar/projects/airpact5/AIRRUNDAY2/${YEAR}/${currentday}00
   endif
...
#> directory set-up ----------------------------------------------------
   ...
   setenv SPECIES_DEF ~airpact5/AIRHOME/run_ap5_day2/post/cctm/combine/spec_def_conc_v2.txt
   setenv INFILE1 $AIROUT/CCTM/ACONC_${currentday}.ncf
   setenv INFILE2 $MCIPDIR/METCRO3D
