...
#	in the above sed operatin, only the substitutions for 2020 and 20200811 are needed in
#	the sed.txt file.
...
setenv LOGS /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081100/LOGS
...
#> directory set-up ----------------------------------------------------
   ...
   set indir      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081100/POST/CCTM
   set mcip       = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081100/MCIP37
   set NCLSCRIPTS = $basedir
#   set PSDIR      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081100/IMAGES/aconc/KFBC
   set PSDIR      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081100/IMAGES/KFBC
   mkdir -p $PSDIR
   #setenv NCARG_ROOT /home/lar/opt/ncl-6.0.0/gcc-4.1.2
...
begin
  ...
  ; must include ".nc" in NCL script)
    f1 = addfile ( "$indir" + "/PM25_24hr_BiasCorrected_2020081100.ncf.nc","r")
  ...
  ; ------------------------------------------------------------------
	...
	; delete(res@cnLevels) 
    	outfile = "$PSDIR"+"/KFBC_PM25_CubicInt_"+"20200811"+"00"
	...
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_LinKrig_"+"20200811"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
	...
	map = gsn_csm_contour_map(wks, x1, res)
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_GausKrig_"+"20200811"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
