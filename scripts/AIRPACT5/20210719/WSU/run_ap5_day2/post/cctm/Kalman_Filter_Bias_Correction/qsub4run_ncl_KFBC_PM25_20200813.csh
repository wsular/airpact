...
#	in the above sed operatin, only the substitutions for 2020 and 20200813 are needed in
#	the sed.txt file.
...
#    JKV 2020/05/29
#
#PBS -N KFBC2-20200813 
#PBS -l nodes=1:amd:ppn=1,mem=5Gb
#PBS -l walltime=00:30:00
#PBS -q lar
#PBS -d /home/airpact5/AIRHOME/run_ap5_day2/post/cctm/KFBC
#PBS -o /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081300/LOGS/post
#PBS -e /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081300/LOGS/post
#PBS -j oe
#PBS -m ae
...
setenv LOGS /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081300/LOGS
...
#> directory set-up ----------------------------------------------------
   ...
   set indir      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081300/POST/CCTM
   set mcip       = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081300/MCIP37
   set NCLSCRIPTS = $basedir
   set PSDIR      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081300/IMAGES/KFBC
   mkdir -p $PSDIR
   #setenv NCARG_ROOT /home/lar/opt/ncl-6.0.0/gcc-4.1.2
...
begin
  ...
  ; must include ".nc" in NCL script)
    f1 = addfile ( "$indir" + "/PM25_24hr_BiasCorrected_2020081300.ncf.nc","r")
  ...
  ; ------------------------------------------------------------------
	...
	; delete(res@cnLevels) 
    	outfile = "$PSDIR"+"/KFBC_PM25_CubicInt_"+"20200813"+"00"
	...
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_LinKrig_"+"20200813"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
	...
	map = gsn_csm_contour_map(wks, x1, res)
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_GausKrig_"+"20200813"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
...
# end of hourly.ncl
      ...
      /home/lar/opt/ncl-6.0.0/gcc-4.1.2/bin/ncl -x $NCLSCRIPTS/hourly.ncl  >&! $LOGS/hourly.ncl_20200813.log
