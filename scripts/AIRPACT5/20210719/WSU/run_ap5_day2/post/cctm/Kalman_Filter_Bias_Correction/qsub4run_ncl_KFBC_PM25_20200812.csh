...
#	in the above sed operatin, only the substitutions for 2020 and 20200812 are needed in
#	the sed.txt file.
...
#PBS -o /home/airpact5/AIRHOME/run_ap5_day1/post/cctm/KFBC/LOGS
#PBS -e /home/airpact5/AIRHOME/run_ap5_day1/post/cctm/KFBC/LOGS
#PBS -j oe
#PBS -m ae
...
setenv LOGS /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081200/LOGS
...
#> directory set-up ----------------------------------------------------
   ...
   set indir      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081200/POST/CCTM
   set mcip       = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081200/MCIP37
   set NCLSCRIPTS = $basedir
#   set PSDIR      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081200/IMAGES/aconc/KFBC
   set PSDIR      = /data/lar/projects/airpact5/AIRRUNDAY2/2020/2020081200/IMAGES/KFBC
   mkdir -p $PSDIR
   #setenv NCARG_ROOT /home/lar/opt/ncl-6.0.0/gcc-4.1.2
...
begin
  ...
  ; must include ".nc" in NCL script)
    f1 = addfile ( "$indir" + "/PM25_24hr_BiasCorrected_2020081200.ncf.nc","r")
  ...
  ; ------------------------------------------------------------------
	...
	; delete(res@cnLevels) 
    	outfile = "$PSDIR"+"/KFBC_PM25_CubicInt_"+"20200812"+"00"
	...
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_LinKrig_"+"20200812"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
	...
	map = gsn_csm_contour_map(wks, x1, res)
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_GausKrig_"+"20200812"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
...
#      /home/lar/opt/ncl-6.0.0/gcc-4.1.2/bin/ncl -Q $NCLSCRIPTS/hourly.ncl
      /home/lar/opt/ncl-6.0.0/gcc-4.1.2/bin/ncl -x $NCLSCRIPTS/hourly.ncl  >&! $LOGS/hourly.ncl.log
