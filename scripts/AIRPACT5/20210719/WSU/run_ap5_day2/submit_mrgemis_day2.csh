...
#  usage examples:
#   
#       ./submit_mrgemis_day2.csh 
#       ./submit_mrgemis_day2.csh <firstday in YYYYMMDD>
#       ./submit_mrgemis_day2.csh <firstday in YYYYMMDD> <runid2waiton>
# 
...
# estimate time required for running the job ---------------------------
  ...
  # (give a 50-100% buffer)
    @ totalminutes = 0
    if ( $RUN_EMIS_MERGE == "Y" )     @ totalminutes = $totalminutes + 40  # JKV 011621 changed from 30 to 40
