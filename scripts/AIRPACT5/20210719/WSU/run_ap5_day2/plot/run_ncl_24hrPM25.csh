...
# 
#   > run_ncl_24hrPM25.csh 20120501 24
#
...
#> during testing 
   ...
   if ( ! $?PBS_O_WORKDIR ) then
      ...
      if ( ! $?MCIPDIR        ) then
            set MCIPDIR   = /data/lar/projects/airpact5/AIRRUNDAY2/$YEAR/${previousday}00/MCIP37
      endif
      set NHR = $2
   endif
...
begin
  ...
  ; ------------------------------------------------------------------
    ...
    do ifilestep = 0, (nstep-1)
       ...
       outfile = "$PSDIR"+"/airpact5_24hrPM25_"+YYYYMMDD2Use+ aPST
