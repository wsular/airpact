...
#> plotting ------------------------------------------------------------
   ...
   if ( $RUN_PLOT_CURTAIN == "Y" ) then
      $PBS_O_WORKDIR/plot/run_ncl_S-N-curtain_at_icol.csh $1 62  >&! $AIRLOGDIR/plot/cctm/S-N-curtain_at_icol.txt
      $PBS_O_WORKDIR/plot/run_ncl_S-N-pm25-curtain_at_icol.csh $1 62  >&! $AIRLOGDIR/plot/cctm/S-N-pm25-curtain_at_icol.txt
      $PBS_O_WORKDIR/plot/run_ncl_W-E-curtain_at_irow.csh $1 198 >&! $AIRLOGDIR/plot/cctm/W-E-curtain_at_irow.txt
      $PBS_O_WORKDIR/plot/run_ncl_W-E-pm25-curtain_at_irow.csh $1 198 >&! $AIRLOGDIR/plot/cctm/W-E-pm25-curtain_at_irow.txt
   endif
