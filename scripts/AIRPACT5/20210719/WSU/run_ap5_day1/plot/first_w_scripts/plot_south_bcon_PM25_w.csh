...
;********************************************************
  ...
  ;             south_APOCI   = APOCI_bcon(${ihour},:,0:284)
  ;
  ;             read in APOCJ
  ;             APOCJ_bcon = fbcon->APOCJ
  ;             south_APOCJ   = APOCJ_bcon(${ihour},:,0:284)
  ;
  ;             read in APNCOMI 
  ;             APNCOMI_bcon = fbcon->APNCOMI
  ;             south_APNCOMI = APNCOMI_bcon(${ihour},:,0:284)
  ;
  ;             read in APNCOMJ 
  ;             APNCOMJ_bcon = fbcon->APNCOMJ
  ;             south_APNCOMJ = APNCOMJ_bcon(${ihour},:,0:284)
  ;
  ;             read in ASO4J
  ...
  ; Sum eleven species into one for PM2.5
        south_PM25 = south_PM25 + south_ANO3J + south_ANH4J + south_ASO4J + south_ANAJ + south_ACLJ
...
;********************************************************
;PM2.5
  wks = gsn_open_wks("ps" ,"$PSDIR"+"/airpact5_BCON_south_PM25_" + "w_$ahour")          ; ps,pdf,x11,ncgm,eps
