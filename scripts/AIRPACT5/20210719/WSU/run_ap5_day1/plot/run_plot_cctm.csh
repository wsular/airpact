...
#> plotting ------------------------------------------------------------
   ...
   if ( $RUN_PLOT_CURTAIN_PSCAA == "Y" ) then
	# echo HERE $PBS_O_WORKDIR/plot/run_ncl_S-N-curtain_at_icol.csh
      $PBS_O_WORKDIR/run_ncl_S-N-curtain_at_icol.csh $1 60 >&! $AIRLOGDIR/plot/cctm/S-N-curtain_at_icol_PSCAA.txt
      $PBS_O_WORKDIR/run_ncl_S-N-pm25-curtain_at_icol.csh $1 60 >&! $AIRLOGDIR/plot/cctm/S-N-pm25-curtain_at_icol_PSCAA.txt
      $PBS_O_WORKDIR/run_ncl_W-E-curtain_at_irow.csh $1 187 >&! $AIRLOGDIR/plot/cctm/W-E-curtain_at_irow_PSCAA.txt
      $PBS_O_WORKDIR/run_ncl_W-E-pm25-curtain_at_irow.csh $1 187 >&! $AIRLOGDIR/plot/cctm/W-E-pm25-curtain_at_irow_PSCAA.txt
