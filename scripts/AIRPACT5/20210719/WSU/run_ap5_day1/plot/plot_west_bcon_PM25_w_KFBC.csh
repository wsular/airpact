...
fbcongrid  = addfile ("$mcip" + "/GRIDBDY2D.nc", "r")
...
;      h_top_agl!0 = "time"
  ...
  ; Lat and Long of grid file for KFBC.  JKV 040120
    LAT= fgrid->LAT(0,0,:,icol)   ; Latitudes TSTEP,LAY,ROW,COL
    LON= fgrid->LON(0,0,:,icol)   ; Longitudes TSTEP,LAY,ROW,COL
...
; 
; for Kalman Filter Bias Correction for PM2.5 project use, export west_PM25(1,:) (layer 1) using print.
; JKV 040120
;     print(west_PM25(0,:))  ; works ok
	plist = [/LAT(0,:),LONG(0,:),west_PM25(0,:)/] 
;     	print_table(plist, "%16.5f,%s,%16.5f,%s,%8.4f")
     	print_table(plist)
;	print(west_PM25(0,:))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
