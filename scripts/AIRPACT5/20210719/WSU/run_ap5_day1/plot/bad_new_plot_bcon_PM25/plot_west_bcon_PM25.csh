...
;********************************************************
  ...
  ;             read in AORGPAJ (OK for 2015 profiles)
                ...
                west_AORGPAJ   = AORGPAJ_bcon(${ihour},:,832:1089)
  ;5
  ;             read in AORGAJ  (OK for 2015 profiles)
                AORGAJ_bcon = fbcon->AORGAJ
                west_AORGAJ   = AORGAJ_bcon(${ihour},:,832:1089)
  ;6
  ...
  ;             read in AORGBJ (OK for 2015 profiles)
                ...
                west_AORGBJ = AORGBJ_bcon(${ihour},:,832:1089)
  ;8
  ...
  ; Sum nine species into one for PM2.5
        west_PM25 = west_PM25 + west_ANO3J + west_ANH4J + west_AORGPAJ + west_AORGAJ 
        west_PM25 = west_PM25 + west_ASO4J  + west_AORGBJ + west_ANAJ + west_ACLJ
