...
setenv ihour $ihour
setenv ahour $ahour
cat > $NCLSCRIPTS/south_bcon.ncl <<EOF
...
;********************************************************
;PM2.5
  wks = gsn_open_wks("ps" ,"$PSDIR"+"/airpact5_BCON_south_PM25_" + "$ahour")          ; ps,pdf,x11,ncgm,eps
...
EOF
# end of south_bcon.ncl

       ncl $NCLSCRIPTS/south_bcon.ncl
...
#/bin/rm -f $NCLSCRIPTS/south_bcon.ncl
exit
