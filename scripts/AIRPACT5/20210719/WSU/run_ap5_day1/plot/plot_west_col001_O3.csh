...
# 
#   > plot_west_col001_O3.csh  20120501 24
#
...
# plot_west_bcon_O3.csh 20120501 24 notes:
...
setenv ihour $ihour
setenv ahour $ahour
cat >! $NCLSCRIPTS/west_conc.ncl <<EOF
...
;********************************************************
;OZONE
  wks = gsn_open_wks("ps" ,"$PSDIR"+"/airpact5_BCON_west_O3_" + "$ahour")          ; ps,pdf,x11,ncgm,eps
...
EOF
# end of west_conc.ncl

       ncl $NCLSCRIPTS/west_conc.ncl
...
# /bin/rm -f $NCLSCRIPTS/west_conc.ncl
exit
