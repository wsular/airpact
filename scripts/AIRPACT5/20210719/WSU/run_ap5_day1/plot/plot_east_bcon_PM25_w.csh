...
# 
#   > plot_east_bcon_PM25_w.csh 20120501 
#
...
;********************************************************
  ...
  ; Sum fifteen species into one for PM2.5
        east_PM25 = east_PM25 + east_ANO3J + east_ANH4J +  east_APOCI + east_APOCJ + east_AOLGAJ
        east_PM25 = east_PM25 + east_AOLGBJ + east_APNCOMI +  east_APNCOMJ + east_ASO4I + east_ASO4J 
        east_PM25 = east_PM25 + east_ANAI + east_ANAJ +  east_ACLI + east_ACLJ
...
;********************************************************
;PM2.5
  wks = gsn_open_wks("ps" ,"$PSDIR"+"/airpact5_BCON_east_PM25_" + "w_$ahour")          ; ps,pdf,x11,ncgm,eps
