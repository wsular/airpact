...
# 
#   > plot_north_bcon_PM25_w.csh 20120501 
#
#    where 20101104 denotes forecast start time of 8 GMT on Nov 5, 2010
#
# Sept 2018: With adoption of code processing WACCM files to BPM25N input file for CMAQ in AIRPACT5, the BCON time steps have changed.
...
;********************************************************
;PM2.5 
  wks = gsn_open_wks("ps" ,"$PSDIR"+"/airpact5_BCON_north_PM25_" + "w_$ahour")          ; ps,pdf,x11,ncgm,eps
