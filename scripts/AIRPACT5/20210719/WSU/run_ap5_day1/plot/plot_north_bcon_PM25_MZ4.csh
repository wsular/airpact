...
# 
#   > plot_north_bcon_PM25_MZ4.csh 20120501 24
#
...
fbcon = addfile ("$indir" + "/BCON/output/bcon_mz4_units_" + "$YEARMMDD" + ".ncf.nc", "r")
...
;********************************************************
  ...
  ;		read in SO4 
        	SO4_bcon = fbcon->SO4 
        	north_PM25 = SO4_bcon(${ihour},:,546:830)
  ;
  ;		read in NH4 
        	NH4_bcon = fbcon->NH4 
        	north_NH4  = NH4_bcon(${ihour},:,546:830)
  ;
  ;		read in NH4NO3
        	NH4NO3_bcon = fbcon->NH4NO3
        	north_NH4NO3 = NH4NO3_bcon(${ihour},:,546:830)
  ;
  ;		read in SOA
        	SOA_bcon = fbcon->SOA
        	north_SOA = SOA_bcon(${ihour},:,546:830)
  ;
  ;		read in CB1
        	CB1_bcon = fbcon->CB1
        	north_CB1   = CB1_bcon(${ihour},:,546:830)
  ;
  ;		read in CB2
        	CB2_bcon = fbcon->CB2
        	north_CB2   = CB2_bcon(${ihour},:,546:830)
  ;
  ;		read in OC1
        	OC1_bcon = fbcon->OC1
        	north_OC1   = OC1_bcon(${ihour},:,546:830)
  ;
  ;		read in OC2
        	OC2_bcon = fbcon->OC2
        	north_OC2   = OC2_bcon(${ihour},:,546:830)
  ;
  ;		read in SA1
        	SA1_bcon = fbcon->SA1
        	north_SA1   = SA1_bcon(${ihour},:,546:830)
  ;
  ;		read in SA2
        	SA2_bcon = fbcon->SA2
        	north_SA2   = SA2_bcon(${ihour},:,546:830)
  ;
  ;		read in SA3
        	SA3_bcon = fbcon->SA3
        	north_SA3   =  0.28 * SA3_bcon(${ihour},:,546:830)
  ;
  ; END READ IN bcon species
  
  ; Sum eleven species into one for PM2.5
	north_PM25 = north_PM25 + north_NH4 + north_NH4NO3 + north_SOA + north_CB1  + north_CB2
	north_PM25 = north_PM25 + north_OC1 + north_OC2 + north_SA1 + north_SA2 + north_SA3 
  ...
  ;    north_PM25!0 = "time"       ; first dimension
      ...
      north_PM25@units = "micrograms/m**3"
...
;********************************************************
;PM2.5 
  wks = gsn_open_wks("ps" ,"$PSDIR"+"/airpact5_MZ4_north_PM25_" + "$ahour")          ; ps,pdf,x11,ncgm,eps
