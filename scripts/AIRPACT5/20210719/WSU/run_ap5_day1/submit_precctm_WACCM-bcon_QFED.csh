...
#  usage examples:
#   
#       ./submit_precctm_WACCM-bcon_QFED.csh 20151123
#       ./submit_precctm_WACCM-bcon_QFED.csh 20151123 76543
# 
...
# job submission -------------------------------------------------------
  # create qsub script
    /bin/sed -f input4sed.txt < blueprints/blueprint_qsub_precctm_WACCM-bcon_QFED.txt > $qsubfile
