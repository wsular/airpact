...
# 
# ./run_run_waccm2bcon.csh <yyyymmdd> 
#
...
# directories and files ------------------------------------------------
  ...
  set prgdir  =  ~airpact5/AIRHOME/run_ap5_day1/bcon_new
...
python -V 
python $prgdir/WACCM_open_plot_write_BCON_py2.py  $currentday >&! WACCM_open_plot_write_BCON_$currentday.log
