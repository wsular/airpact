...
# 
#   > ./run_CAM-chem-2017_2bcon_py2_10step.csh 20151113
#
...
# download CAM-chem file if necessary ----------------------------------
  ...
  if ( ! -e $camchemfile1 ) then
        ...
        echo "wget -N -nv --no-check-certificate https://www.acom.ucar.edu/cam-chem/DATA/2017/${camchemfile1}"
        wget -N -nv --no-check-certificate https://www.acom.ucar.edu/cam-chem/DATA/2017/${camchemfile1}
        ls -lt $camchemfile1
  endif
  if ( ! -e $camchemfile2 ) then
        echo "download CAM-chem file" $camchemfile2
        echo "wget -N -nv --no-check-certificate https://www.acom.ucar.edu/cam-chem/DATA/2017/${camchemfile2}"
        wget -N -nv --no-check-certificate https://www.acom.ucar.edu/cam-chem/DATA/2017/${camchemfile2}
        ls -lt $camchemfile2
  endif
  if ( ! -e $camchemfile3 ) then
        echo "download CAM-chem file" $camchemfile3
        echo "wget -N -nv --no-check-certificate https://www.acom.ucar.edu/cam-chem/DATA/2017/${camchemfile3}"
        wget -N -nv --no-check-certificate https://www.acom.ucar.edu/cam-chem/DATA/2017/${camchemfile3}
        ls -lt $camchemfile3
  endif
