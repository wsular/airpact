### ? do I need a shebang line for running python 3? #/usr/bin/python
...
### Old_py2  # I want true division in python 2.* so I added this.
### Old_py2 from __future__ import division # tested by # testx = 1/2 ; print testx # got: 0.5 # OK

import sys  					# pip3 did not find
import netCDF4 					# pip3 says already satisfied
from netCDF4 import Dataset
import matplotlib as mpl			# pip3 says already satisfied
import matplotlib.pyplot as plt 		#pip3 says already satisfied
from matplotlib.cm import get_cmap 
# from mpl_toolkits.basemap import Basemap 	# pip3 did not find.  Is mpl_toolkits related to mpl as matplotlib?
import cartopy.crs as crs 			# pip3 installed, after 'module load proj/4.9.2'
import cartopy.feature as cfeature 
from glob import glob  				# pip3 did not find
import numpy as np  				# pip3 says already satisfied
import pandas as pd 				# pip3 says already satisfied
import scipy as sc  				# pip3 says already satisfied
#from scipy.stats.stats import pearsonr 
#from scipy import constants
from scipy.constants import *
### Old_py2 # print "The molar gas constant R:", R
import xarray as xr  				# pip3 says already satisfied
#import matplotlib as mpl
import os.path 					# pip3 did not find either os or os.path
#from time import time
import time 					# pip3 did not find
...
# P_in_Z[0,0,0,0]
# 2 to 3 edit JKV  for tdx in range(waccm_ntime):
for tdx in list(range(waccm_ntime)):
    print ("tdx:", tdx)
    #print (P_in_Z[tdx,0,0,0])
    for levdx in list(range(waccm_nlev)):
        #print ("levdx:", levdx)
...
#BCON_TSTEP_TIMES = ( 60000, 120000,180000,000000,60000,120000,180000,000000,60000,120000 ) 
BCON_TSTEP_DATES = ( 2021230, 2021230, 2021230, 2021231, 2021231, 2021231, 2021231, 2021232, 2021232, 2021232)
#BCON_TSTEP_TIMES = ( 060000, 120000,180000,000000,060000,120000,180000,000000,060000,120000 )
BCON_TSTEP_TIMES = ( 60000, 120000,180000,000000,60000,120000,180000,000000,60000,120000 ) 
