...
#				See flag REDATE
#  20191002      Joe Vaughan	Yikes!  Stale WACCM files can be a problem if they were grabbed when not final/static.
#				Scrub out WACCM files each time and reacquire all required files. Refresh => '_ref'
...
## Old_py2# Amend setup to use anaconda2 python 2 stuff:
## Old_py2alias python '/share/apps/anaconda2-4.3.0/bin/python'
## Old_py2# 
## Old_py2setenv PYTHONPATH ${NETCDF}/share/apps/anaconda2-4.3.0/bin:/share/apps/anaconda2-4.3.0/pkgs
## Old_py2setenv PATH ${PYTHONPATH}:${PATH}
...
# pre2019-06-09  set waccmfile1 = f.e21.FWSD.f09_f09_mg17.forecast.001.cam.h3.${YEAR}-${MONTH}-${DAY}-00000.nc 
# pre2019-06-09  set waccmfile2 = f.e21.FWSD.f09_f09_mg17.forecast.001.cam.h3.${NYEAR}-${NMONTH}-${NDAY}-00000.nc 
# pre2019-06-09  set waccmfile3 = f.e21.FWSD.f09_f09_mg17.forecast.001.cam.h3.${NNYEAR}-${NNMONTH}-${NNDAY}-00000.nc 
...
# SCRUBBING OUT OLD FILES COMMENTED OUT FOR py2 to py3 update  testing.  JKV 042020
# rm -fv $waccmfile1
 #rm -fv $waccmfile2
  #rm -fv $waccmfile3
...
cat $prgdir/WACCM_open_plot_write_BCON_py3_10step.template.py | sed -f BCON_DATE.txt >! $prgdir/today.py3
...
echo python3 -V 
echo "python3 $prgdir/today.py3  $currentday >&!  $AIRLOGDIR/bcon/WACCM_open_plot_write_BCON_py3.log"
