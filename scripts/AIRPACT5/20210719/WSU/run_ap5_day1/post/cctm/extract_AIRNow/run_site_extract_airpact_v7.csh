...
# 
#   > ./run_site_extract_airpact_v7.csh 20160223
#
#  2018-08-14    Joe Vaughan  updated to call updated v7 (sci. not. output) script for extract_AIRNow:
#   	1) to get fresh AIRNow sites daily, 
#   	2) to call v7 executable extracting (CO, NO, NO2, NOX, O3, PM2.5, PM10, SO2, WSPM2.5) and include header w/ units.
#
