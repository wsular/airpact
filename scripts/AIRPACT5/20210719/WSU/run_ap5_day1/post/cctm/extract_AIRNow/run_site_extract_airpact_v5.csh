...
# 
#   > ./run_site_extract_airpact_v5.csh 20160223
#
#       This script extract hourly O3, PM2.5, WSPMPM.25, NOx, NO2, NO and CO tracer results 
#       from CMAQ AirNOW sites.q  JKV December 2016.
...
#> check environment variable ------------------------------------------
   ...
   if ( ! $?AIRRUN ) then
      #set AIRRUN  = /data/lar/projects/airpact5/AIRRUNDAY2/$YEAR  AIRRUNDAY2 seems wrong.  AIRRUN is set in calling script anyway. JKV 091217
...
#> run the extraction script -------------------------------------------
   ...
   cd $AIROUT/POST/CCTM
   ~airpact5/AIRHOME/build/extract_AIRNow/site_extract_v5.x   >&! $AIRLOGDIR/post/log04c_post_xtr4airnow.txt
