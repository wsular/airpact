...
#	in the above sed operatin, only the substitutions for 2021 and 20210721 are needed in
#	the sed.txt file.
...
#PBS -o /data/lar/projects/airpact5/AIRRUN/2021/2021072100/LOGS/post
#PBS -e /data/lar/projects/airpact5/AIRRUN/2021/2021072100/LOGS/post
#PBS -j oe
#PBS -m ae
...
setenv LOGS /data/lar/projects/airpact5/AIRRUN/2021/2021072100/LOGS/post
...
#> directory set-up ----------------------------------------------------
   ...
   set indir      = /data/lar/projects/airpact5/AIRRUN/2021/2021072100/POST/CCTM
   set mcip       = /data/lar/projects/airpact5/AIRRUN/2021/2021072100/MCIP37
   set NCLSCRIPTS = $basedir
   set PSDIR      = /data/lar/projects/airpact5/AIRRUN/2021/2021072100/IMAGES/KFBC
   mkdir -p $PSDIR
   #setenv NCARG_ROOT /home/lar/opt/ncl-6.0.0/gcc-4.1.2
...
begin
  ...
  ; must include ".nc" in NCL script)
    f1 = addfile ( "$indir" + "/PM25_24hr_BiasCorrected_2021072100.ncf.nc","r")
  ...
  ; ------------------------------------------------------------------
	...
	; delete(res@cnLevels) 
    	outfile = "$PSDIR"+"/KFBC_PM25_CubicInt_"+"20210721"+"00"
	...
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_LinKrig_"+"20210721"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
	...
	map = gsn_csm_contour_map(wks, x1, res)
	draw(map)
	outfile = "$PSDIR"+"/KFBC_PM25_GausKrig_"+"20210721"+"00"
	wks = gsn_open_wks("ps", outfile )
	gsn_define_colormap(wks,"WhBlGrYeRe")
...
# end of hourly.ncl
      ...
      /home/lar/opt/ncl-6.0.0/gcc-4.1.2/bin/ncl -x $NCLSCRIPTS/hourly.ncl  >&! $LOGS/hourly.ncl_20210721.log
