...
ncfilename = outdir+'/PM25_24hr_BiasCorrected_GausKri_'+str(date)+'00.ncf'
...
#Interpolation Method: Gaussian Krig
...
m3_file = xr.open_dataset('/home/airpact5/AIRHOME/run_ap5_day1/post/cctm/KFBC2/Models-3_template_1step_1var_1layer.ncf')

biascorrected_nc = m3_file.rename({'RollingA24_PM25':'KFBC_PM25_GausKri'})

biascorrected_nc['KFBC_PM25_GausKri'][0,0,:,:] = kf_gauskrig
biascorrected_nc = biascorrected_nc.assign(KFBC_PM25_GausKri=biascorrected_nc.KFBC_PM25_GausKri.assign_attrs({'long_name':'KFBC_PM25_GausKri','var_desc':'24 hr average of KFBC with Gaussian Krigged'}))
biascorrected_nc = biascorrected_nc.assign_attrs({'CDATE':SDATE,'CTIME':STIME,'WDATE':SDATE,'WTIME':STIME,'SDATE':SDATE,'STIME':STIME,'VAR-LIST':'KFBC_PM25_GausKri','FILEDESC':'24 hr average AIRPACT 5 bias correction Gaussian Krigged'})
