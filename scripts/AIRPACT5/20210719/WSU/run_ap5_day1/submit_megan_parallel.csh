...
#  usage examples:
#   
#       ./submit_megan_parallel.csh 
#       ./submit_megan_parallel.csh 20160430
#       ./submit_megan_parallel.csh 20151123  76543
# 
...
#  set megan_epiday      = 20160501
   set megan_epiday      = $thisyear$thismonth$today
...
# create qsub file -----------------------------------------------------
  set qsubfile = "qsub4meganparallel.csh"
...
s+__DAY__+${today}+g
s+__RUN_EMIS_MEGAN_PARALLEL__+${RUN_EMIS_MEGAN_PARALLEL}+g
...
# job submission -------------------------------------------------------
  # create qsub script
    ...
    echo `date` "submitting megan_parallel for" $currentday
...
# JKV debugging why megan sometimes dies  100317
